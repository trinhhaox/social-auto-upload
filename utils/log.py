...
twitter_logger = create_logger('twitter', 'logs/twitter.log')
threads_logger = create_logger('threads', 'logs/threads.log')
pinterest_logger = create_logger('pinterest', 'logs/pinterest.log')
zalo_logger = create_logger('zalo', 'logs/zalo.log')
